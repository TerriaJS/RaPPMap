 ...
 *
 * @alias SelectASelectAPolygonParameter
 * @constructor
...
SelectAPolygonParameter.prototype.formatValueAsString = function(value) {
    if (!defined(value)) {
        return '-';
    }
...
SelectAPolygonParameter.prototype.getGeoJsonFeature = function(value) {
    debugger;
