...
var createBingBaseMapOptions = function(terria, bingMapsKey) {
    ...
    result.push(new BaseMapViewModel({
        image: require('../../wwwroot/images/bing-aerial-labels-world.png'),
    ...
    result.push(new BaseMapViewModel({
        image: require('../../wwwroot/images/bing-aerial-world.png'),
    ...
    result.push(new BaseMapViewModel({
        image: require('../../wwwroot/images/bing-maps-roads-world.png'),
