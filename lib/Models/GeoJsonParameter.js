...
GeoJsonParameter.prototype.getProcessedValue = function(value) {
    if (this.subtype === GeoJsonParameter.PointType) {
        return PointParameter.formatValueForUrl(value, this);
    }
    if (this.subtype === GeoJsonParameter.SelectAPolygonType) {
        return SelectAPolygonParameter.formatValueForUrl(value, this);
    }
    if (this.subtype === GeoJsonParameter.PolygonType) {
        return PolygonParameter.formatValueForUrl(value, this);
    }
    var that = this;
    return this.regionParameter.regionProvider.getRegionFeature(this._terria, value, undefined).then(function(feature) {
        var regionParameterString = that.id + '=' + JSON.stringify({
